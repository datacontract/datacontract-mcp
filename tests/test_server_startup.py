...
class TestServerStartup(unittest.TestCase):
    ...
    def test_import_server(self):
        ...
        from src.datacontract_mcp import server
    ...
    def test_data_sources_available(self):
        ...
        from src.datacontract_mcp.sources.data_source import DataSourceRegistry, ServerType, DataSourcePlugin
        ...
        try:
            ...
            if databricks_source:
                ...
                with patch.dict(os.environ, {
                    ...
                    from src.datacontract_mcp.sources.data_plugins.databricks import DatabricksDataSource
